...
- [.NET Core SDK 5.0.x for Windows](https://www.microsoft.com/net/download/windows)

#### For Linux

- [.NET Core SDK 5.0.x for Linux](https://www.microsoft.com/net/download/linux)

#### For Mac

- [.NET Core SDK 5.0.x for MacOS](https://www.microsoft.com/net/download/macos)
